...
import com.example.e_covid.UI_Layer.View.QuarantineCenter.User.User_ViewQuarantineCenter;

import java.util.ArrayList;

public class User_QuarantineCenterAdapter extends RecyclerView.Adapter<User_QuarantineCenterAdapter.MyViewHolder>{
    ...
    @NonNull
    @Override
    public User_QuarantineCenterAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        LayoutInflater inflater = LayoutInflater.from(context);
        View view = inflater.inflate(R.layout.row, parent, false);
        return new User_QuarantineCenterAdapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final User_QuarantineCenterAdapter.MyViewHolder holder, int position ) {
        ...
        holder.mainLayout.setOnClickListener(view -> {
            Intent intent = new Intent(context, User_ViewQuarantineCenter.class);
